...
if(localStorage.key(j) === "mapbox.eventData.uuid:YXdlZ2hvcnN0" || localStorage.key(j) === "mapbox.eventData:YXdlZ2hvcnN0"){
  ...
  var events1 = document.createElement("p");
    ...
    // var dates = event[5];
    console.log("This is event[0]" + event[0]);
     events1.innerHTML = event[0] + " - " + event[1];
     document.getElementById("trip-list").appendChild(events1);
}
/*
...
.textContent;
  ...
  localStorage.setItem(userInfo[1], JSON.stringify(userInfo));
